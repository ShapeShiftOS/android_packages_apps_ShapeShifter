package com.ssos.shapeshifter.navigation;
...
import com.ssos.shapeshifter.navigation.ViewUtils;
        ...
        if (attrs != null) {
            ...
            try {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
                    icon = ta.getDrawable(R.styleable.BubbleToggleView_shapeshiftos_icon);
                else
                icon = AppCompatResources.getDrawable(getContext(), ta.getResourceId(R.styleable.BubbleToggleView_shapeshiftos_icon, R.drawable.default_icon));
                iconWidth = ta.getDimension(R.styleable.BubbleToggleView_shapeshiftos_iconWidth, iconWidth);
                iconHeight = ta.getDimension(R.styleable.BubbleToggleView_shapeshiftos_iconHeight, iconHeight);
                shape = ta.getDrawable(R.styleable.BubbleToggleView_shapeshiftos_shape);
                shapeColor = ta.getColor(R.styleable.BubbleToggleView_shapeshiftos_shapeColor, shapeColor);
                showShapeAlways = ta.getBoolean(R.styleable.BubbleToggleView_shapeshiftos_showShapeAlways, false);
                title = ta.getString(R.styleable.BubbleToggleView_shapeshiftos_title);
                titleSize = ta.getDimension(R.styleable.BubbleToggleView_shapeshiftos_titleSize, titleSize);
                colorActive = ta.getColor(R.styleable.BubbleToggleView_shapeshiftos_colorActive, colorActive);
                colorInactive = ta.getColor(R.styleable.BubbleToggleView_shapeshiftos_colorInactive, colorInactive);
                isActive = ta.getBoolean(R.styleable.BubbleToggleView_shapeshiftos_active, false);
                animationDuration = ta.getInteger(R.styleable.BubbleToggleView_shapeshiftos_duration, DEFAULT_ANIM_DURATION);
                internalPadding = (int) ta.getDimension(R.styleable.BubbleToggleView_shapeshiftos_padding, internalPadding);
                titlePadding = (int) ta.getDimension(R.styleable.BubbleToggleView_shapeshiftos_titlePadding, titlePadding);
            } finally {
                ta.recycle();
            }
        }
